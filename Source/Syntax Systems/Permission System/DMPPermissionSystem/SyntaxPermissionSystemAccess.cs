...
namespace PermissionSystem
{
    ...
    /// </summary>
    public class PermissionSystemAccess
    {
        // Used for programmatic access to the syntax permission system
        static private PermissionSystemCore.PlayerSecurity ps = new PermissionSystemCore.PlayerSecurity();
        ...
        static public class PVessel
        {
            ...
            static public bool ClaimVessel(string playername, string vesselid, PermissionSystemCore.VesselAccessibilityTypes _vat)
            {
                bool flag = false;
            ...
            static public bool ChangeVesselAccessibility(string playername, string vesselid, PermissionSystemCore.VesselAccessibilityTypes _vat)
            {
                bool flag = false;
            ...
            static public KeyValuePair<string,PermissionSystemCore.PlayerVessel> SpectateMode(string vesselid)
            {
                KeyValuePair<string, PermissionSystemCore.PlayerVessel> returndata = new KeyValuePair<string, PermissionSystemCore.PlayerVessel>();
                ...
                if (FindLockedPlayerVessel(vesselid, out returndata))
                {
                    ...
                    else
                    {
                        ...
                        returndata = new KeyValuePair<string, PermissionSystemCore.PlayerVessel>("VesselNotFound", new PermissionSystemCore.PlayerVessel());
                    }
                }
                return returndata;
            }
            ...
            static public bool FindPlayerVessel(string playername, string vesselid, out KeyValuePair<string, PermissionSystemCore.PlayerVessel> playerVesselEntry)
            {
                bool flag = false;
                KeyValuePair<string, PermissionSystemCore.PlayerVessel> datafound = ps.ReturnPlayerVessel(playername, vesselid);
                ...
                {
                    datafound = new KeyValuePair<string, PermissionSystemCore.PlayerVessel>();
                }
                playerVesselEntry = datafound;
                return flag;
            }
            static public bool FindLockedPlayerVessel(string vesselid, out KeyValuePair<string, PermissionSystemCore.PlayerVessel> playerVesselEntry)
            {
                bool flag = false;
                KeyValuePair<string, PermissionSystemCore.PlayerVessel> datafound = ps.ReturnLockedPlayerVessel(vesselid);
                if (datafound.Key != null)
                {
                    flag = true;
                }
            ...
            static public bool UnClaimVessel(string playername, string vesselid)
            {
                bool flag = false;
                if(ps.RemoveVesselFromProtection(playername, vesselid))
                {
                    flag = true;
                }
                return flag;
        ...
        {
            static public bool AddGroup(string _gname, string _gadmin, PermissionSystemCore.VesselAccessibilityTypes _gvat)
            {
                return ps.AddPlayerGroup(_gname, _gvat, _gadmin);
            }

            static public bool EditGroupVesselAccessibility(string _gname, string _gadmin, PermissionSystemCore.VesselAccessibilityTypes _gvat)
            {
            ...
            static public bool ClaimVesselForGroup(string _playername, string _vesselid, PermissionSystemCore.VesselAccessibilityTypes _vat)
            {
                bool flag = false;
            ...
            static public bool ChangeVesselAccessibility(string _playername, string _gname, string _vesselid, PermissionSystemCore.VesselAccessibilityTypes _gvat)
            {
                bool flag = false;
