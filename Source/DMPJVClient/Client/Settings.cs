...
namespace DarkMultiPlayer
{
    public class Settings
    {
        ...
        public Settings()
        {
            string darkMultiPlayerDataDirectory = Path.Combine(Path.Combine(Path.Combine(Path.Combine(KSPUtil.ApplicationRootPath, "GameData"), "DMPJointVentureClient"), "Plugins"), "Data");
